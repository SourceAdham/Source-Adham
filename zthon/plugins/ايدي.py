...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    if user_id == 5093806483 or user_id == 5746412340:
        rotbat = "⌁ مطـور السـورس 𓄂𓆃 ⌁" 
    elif user_id == 5935011961 or user_id == 5811133066:
